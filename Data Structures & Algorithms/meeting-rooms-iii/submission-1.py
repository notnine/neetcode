...
class Solution:
    def mostBooked(self, n: int, meetings: List[List[int]]) -> int:
        ...
        ongoing_meetings = [] # ongoing meetings sorted by end time decr. contains tuples of (end time, room, start time)
        ...
        for meeting in meetings:
            ...
            while ongoing_meetings and ongoing_meetings[0][0] <= meeting[0]:
                ...
                heapq.heappush(free_rooms, popped_meeting[1])
            ...
            if not free_rooms:
                ...
                smallest_avail_room = soonest_ending_meeting[1]
            ...
            heapq.heappush(ongoing_meetings, (meeting[1], smallest_avail_room, meeting[0]))
